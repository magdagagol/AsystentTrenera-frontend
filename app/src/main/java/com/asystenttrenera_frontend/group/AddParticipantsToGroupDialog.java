...
public class AddParticipantsToGroupDialog extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = layoutInflater.inflate(R.layout.layout_add_oarticipants_to_group_dialog, null);

        builder.setView(view)
                .setTitle("Dodaj zawodników")
